...
NOTE: Universal APIs are automatically discovered and mounted by Enonic XP when placed in the `/apis/` directory. No additional configuration in site.xml, webapp.xml, or admin-tool.xml is required.
