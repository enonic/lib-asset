...
The Asset library bundles a Universal API endpoint that handles the serving of assets. A Universal API URL may look something like this: `/_/{app-name}:asset/{app-fingerprint}/path/to/asset.ext`
