...
When I call assetUrl with the following parameters:
  ...
  | path        | index.css                                                                   |
  | type        | absolute                                                                    |
Then I should get the following url "http://localhost:8080/webapp/com.example.myproject/_/service/com.example.another/asset/index.css?array=one%2Ctwo%2Cthree&boolean=true&number=0&string=string"
